<div class="main-portfolio" id="portfolio">
    ...
    <div class="container">
        <div id="Container" class="filter-gallery">
            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="1" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/aumevent.png" data-fancybox="group"> <img class="img-responsive oyee" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/aumevent.png">
				</a> </div>
            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="1" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/aumdigital.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/aumdigital.png">
				</a> </div>
            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="1" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/mentallica.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/mentallica.png">
				</a> </div>

            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="1" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/booksy.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/booksy.png">
				</a> </div>
            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/booxchg.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/booxchg.png">
				</a> </div>
            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/easychef.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/easychef.png"></a> </div>
            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/eatlocal.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/eatlocal.png"></a> </div>
            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/operr.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/operr.png"></a> </div>
            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/Shoponlady.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/Shoponlady.png"></a> </div>
            <div class="mix category-2 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/mobile-app/stroll.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/mobile-app/stroll.png"></a> </div>
            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/showinmycity.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/showinmycity.png"></a> </div>
            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/bookmix.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/bookmix.png"></a> </div>

            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/rmb-club.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/rmb-club.png"></a> </div>
            <div class="mix category-1 col-xs-6 col-sm-4 col-md-3" data-my-order="2" style="display: inline-block;" data-bound=""> <a class="example-image-link" href="images/portfolio-img/website/laki-laka.png" data-fancybox="group"> <img class="img-responsive" alt="" src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio-img/website/laki-laka.png"></a> </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="contact-head">let's start your project</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3 form-main-log">
                            <div class="form-group">
                                <input type="text" class="form-control change" placeholder="Your Name *" id="name" name="name" data-validation-required-message="Please enter your name." required>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control change" id="email" name="email" placeholder="Your Email *" required data-validation-required-message="Please enter your email address.">
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="tel" class="form-control change" id="phone" name="phone" placeholder="Your Phone *" required data-validation-required-message="Please enter your phone number.">
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control change" id="message" name="message" placeholder="Your Message *" required data-validation-required-message="Please enter a message."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>                            
                        </div>
                        <div class="clearfix"></div>
...
<div class="container-fluid second-sec-bg">
    ...
    <div class="location" style="top: 40%;left: 14%;" id="example" rel="popover" data-content="200 Summit Lake Drive, Valhalla, NY 10595" data-placement="top" data-trigger="hover" data-original-title="AMERICA">
        <div class="pulse"></div>
    </div>

    <div class="location" style="top:49%;left:26%;" id="example" rel="popover" data-content="Building No 4, Office 221 Gold and Diamond Park P.O.Box 102755, Dubai UAE." data-placement="top" data-trigger="hover" data-original-title="MIDDLE EAST">
        <div class="pulse"></div>
    </div>
            ...
            <section class="container1 full-bleed-no-max m-full-bleed footer1-wrapper phone-at-567" id="footer1-wrapper">
                ...
                <div class="container1">
                    <div class="grid grid-footer1 clearfix">
                        <div class="footer1-signature"> <span class="footer1-copyright">&copy; 2017 JUSTCODEINDIA</span>
                            <p class="footer1-legal-links">
                                <a data-new-win="yes" href="#" title="Terms and Conditions">Terms and Conditions</a>
                                <a data-new-win="yes" href="#" title="Privacy Policy">Privacy Policy</a>
                            </p>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="myModal2" role="dialog" style="z-index:999999999999999;">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Send us an e-mail with the subject of job title at careers@justcode.com</p>
            </div>
            <div class="modal-footer">
                <button class="btn btn-default" data-dismiss="modal" type="button">Close</button>
            </div>
